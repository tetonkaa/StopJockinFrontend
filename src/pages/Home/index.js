    ...
    <div className="homeContainer">
      <div>
        <div className="homeText">
          ...
          <h1 className="largeLogo animate__animated animate__fadeInUp animate__slow animate__repeat-1">
            Stop Jockin
          </h1>

          <p className="subtext">
            Fine Cuts, Classic New Orleans style snoBalls, and other Stop Jockin
