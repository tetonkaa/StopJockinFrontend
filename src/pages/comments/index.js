...
export default function Comments({isLoggedIn, setIsLoggedIn}) {
    ...
    const [formState, setFormState] = useState({
        ...
        async function deleteUser() {
            ...
            await axios.delete('https://jockloc.herokuapp.com/api/user', config)
     ...
     async function updateUsername(formState) {
        const config = {
            ...
            const {_id} = formState;
            const updatedData = await axios.put(`https://jockloc.herokuapp.com/api/user/${_id}`, formState, config)
    ...
    async function getUserName() {
        ...
        const { data } = await axios.get('https://jockloc.herokuapp.com/api/user', config)
