...
import ControlledCarousel from "../../components/snoBallCarousel/snoBallCarousel";
  ...
  return (
    <div className="snoballContainer">
      ...
      <div className="snoballBG">
        <svg
          id="visual"
          viewBox="0 0 1950 950"
          width="1950"
          height="950"
          xmlns="http://www.w3.org/1950/svg"
          version="1.1"
        >
          ...
          <defs>
            <linearGradient id="grad1_0" x1="64.3%" y1="0%" x2="100%" y2="100%">
              <stop
                offset="-5.970588235294112%"
                stopColor="#ff5c5d"
                stopOpacity="1"
              ></stop>
              <stop
                offset="105.97058823529412%"
                stopColor="#ff5c5d"
                stopOpacity="1"
              ></stop>
            </linearGradient>
